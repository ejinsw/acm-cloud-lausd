...
const testSubjects = [
  ...
  {
    name: 'Chemistry',
    description: 'Organic chemistry, inorganic chemistry, and biochemistry',
    category: 'STEM',
    level: 'High School',
  },
  {
  ...
  {
    name: 'History',
    description: 'World history, American history, and government',
    category: 'Humanities',
    level: 'High School',
  },
  {
...
const testInstructors = [
  {
    ...
    experience: [
      ...
      'Published 10+ research papers in mathematics education',
      'Led district-wide curriculum development',
    ],
  ...
  },
  {
    ...
    certificationUrls: [
      'https://example.com/spanish-cert.pdf',
      'https://example.com/tesol-cert.pdf',
    ],
    averageRating: 4.7,
    subjects: ['Spanish'],
  },
  {
    ...
    experience: [
      '10 years as software engineer at Google',
      '5 years teaching computer science',
  ...
  },
  {
    ...
    education: [
      ...
      'B.A. English - Princeton',
    ],
    experience: [
      '20 years teaching literature',
      'Published author of 2 novels',
...
const testSessions = [
  {
    ...
    description:
      'Master the core concepts of calculus including limits, derivatives, and integrals. Perfect for students preparing for AP Calculus.',
  ...
  },
  {
    ...
    description:
      "Hands-on physics lab session covering Newton's laws, motion, and energy conservation.",
    ...
    objectives: [
      ...
      'Analyze force and acceleration',
  ...
  },
  {
    ...
    description:
      'Interactive Spanish conversation session focusing on everyday vocabulary and cultural topics.',
  ...
  },
  {
    ...
    description:
      "Deep dive into Shakespeare's Hamlet, exploring themes, characters, and literary devices.",
...
async function createInstructors() {
  ...
  for (const instructor of testInstructors) {
    try {
      ...
      console.error(
        `✗ Error creating instructor ${instructor.firstName} ${instructor.lastName}:`,
        error.message
      );
    }
  }
