...
import { User, Bell, Shield, CheckCircle2, XCircle } from "lucide-react";
              ...
              <Stack>
                ...
                <Stack gap="md">
                  ...
                  <Checkbox
                    ...
                    description="Get reminded about upcoming tutoring sessions"
                  ...
                  <Checkbox
                    ...
                    description="Get notified when new sessions are available"
                    checked={notificationSettings.newSessionAlerts}
                    onChange={(e) => handleNotificationChange('newSessionAlerts', e.target.checked)}
                  />
                  <Checkbox
                    label="Grade Updates"
                    description="Receive updates on your academic progress"
