    ...
    <Container size="xl" py="xl">
      ...
      <Paper p="xl" radius="md" withBorder mb="xl">
        ...
        {completionPercentage === 100 ? (
          <Alert icon={<CheckCircle size={16} />} title="Ready to Create!" color="green">
            All required fields are completed. You can now create your session!
          </Alert>
        ) : (
          <Alert icon={<AlertCircle size={16} />} title="Complete Required Fields" color="blue">
            Please complete all required fields before creating your session.
          </Alert>
        )}
      ...
      <Grid gutter="lg">
        ...
        <Grid.Col span={{ base: 12, lg: 4 }}>
          <Stack gap="lg">
            ...
            <Paper p="lg" radius="md" withBorder>
              <Stack gap="md">
                <Text size="lg" fw={500}>Ready to create your session?</Text>
                <Text size="sm" c="dimmed">
                  Review your session details and click create when ready
                </Text>
