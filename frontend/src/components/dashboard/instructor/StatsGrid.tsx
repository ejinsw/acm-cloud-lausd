...
export function StatsGrid({ totalSessions, hoursTutored, reviewCount }: StatsGridProps) {
  return (
    <Box style={{ borderTop: "1px solid var(--mantine-color-gray-3)" }}>
      <SimpleGrid cols={{ base: 2, sm: 3 }} spacing="lg" py="lg">
        ...
        <StatItem label="Hours spent teaching" value={hoursTutored} icon={Clock} />
        <StatItem label="Reviews received" value={reviewCount} icon={Star} />
      </SimpleGrid>
    </Box>
  );
}
